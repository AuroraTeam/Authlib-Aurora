...
public class YggdrasilUserAuthentication extends HttpUserAuthentication {
   ...
   public YggdrasilUserAuthentication(YggdrasilAuthenticationService authenticationService, String clientToken, Agent agent, Environment env) {
      ...
      this.routeAuthenticate = HttpAuthenticationService.constantURL(env.getAuthHost() + "/v1/authserver/authenticate");
      this.routeRefresh = HttpAuthenticationService.constantURL(env.getAuthHost() + "/v1/authserver/refresh");
      this.routeValidate = HttpAuthenticationService.constantURL(env.getAuthHost() + "/v1/authserver/validate");
      this.routeInvalidate = HttpAuthenticationService.constantURL(env.getAuthHost() + "/v1/authserver/invalidate");
      this.routeSignout = HttpAuthenticationService.constantURL(env.getAuthHost() + "/v1/authserver/signout");
   }
